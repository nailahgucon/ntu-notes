...
<span class="tags"><a href="/notes/data-structures-and-algorithms/algorithms/graph/adjM2adjL/">adjM2adjL()</a></span>
<span class="tags"><a href="/notes/data-structures-and-algorithms/algorithms/graph/adjL2adjM/">adjL2adjM()</a></span>
<hr>

The degree of a vertex v of a graph is the number of edges incident on *v*. Write a function <span class="functions">calDegreeV()</span> to compute vertex degrees using adjacent lists and using adjacency matrix. Please reuse the work done in Q1(adjM2adjL()) and Q2(adjL2adjM()).
<br><br>

**The function prototype is given as follows:**

<span class="functions">void calDegreeV ( Graph g, int * degreeV );</span>
<br><br>
