...
Write a function adjL2adjM() to convert an adjacency list to an adjacency matrix. Please reuse the work down in Q1 (adjM2adjL()).
<br><br>

**The function prototype is given as follows:**

<span class="functions">void adjL2adjM ( Graph *g);</span>
<br><br>
